...
const translations = {
  ar: {
    ...
    // Dashboard Switcher & Contracts Mode
    dash_mode_quotations: 'عروض الأسعار',
    dash_mode_contracts: 'العقود',
    dash_switch_tooltip: 'تبديل لوحة التحكم بين عروض الأسعار والعقود',
    dash_quotations_title: 'لوحة تحكم عروض الأسعار',
    dash_contracts_title: 'لوحة تحكم العقود الهندسية',
    kpi_total_contracts: 'إجمالي العقود',
    kpi_contracts_this_month: 'عقود هذا الشهر',
    kpi_contracts_highest: 'أعلى قيمة عقد',
    filter_all_contract_types: 'جميع أنواع العقود',
    chart_contracts_branch_title: 'العقود حسب الفروع',
    chart_contracts_status_title: 'العقود حسب الحالة',
    chart_contracts_type_title: 'العقود حسب نوع العقد',
    chart_contracts_trend_title: 'العقود الشهرية',
    contracts_month_section_title: 'أحدث العقود المسجلة',
    contracts_month_section_subtitle: 'قائمة بالعقود الهندسية المسجلة والموثقة في الأرشيف',
    col_contract_no: 'رقم العقد',
    col_signing_date: 'تاريخ التوقيع',
    total_contracts_value_label: 'إجمالي قيمة العقود',
    top_contract_label: 'أعلى عقد قيمة',
    ...
    filter_date_range: 'النطاق الزمني',
    filter_date_all: 'كافة التواريخ',
  ...
  en: {
    ...
    contracts_empty_desc: 'Manage and archive approved contracts for engineering projects linked to archived quotations.',
    ...
    // Dashboard Switcher & Contracts Mode
    dash_mode_quotations: 'Quotations',
    dash_mode_contracts: 'Contracts',
    dash_switch_tooltip: 'Switch dashboard between Quotations and Contracts',
    dash_quotations_title: 'Quotations Dashboard',
    dash_contracts_title: 'Contracts Dashboard',
    kpi_total_contracts: 'Total Contracts',
    kpi_contracts_this_month: 'Contracts This Month',
    kpi_contracts_highest: 'Highest Contract Value',
    filter_all_contract_types: 'All Contract Types',
    chart_contracts_branch_title: 'Contracts by Branch',
    chart_contracts_status_title: 'Contracts by Status',
    chart_contracts_type_title: 'Contracts by Type',
    chart_contracts_trend_title: 'Monthly Contracts Trend',
    contracts_month_section_title: 'Recent Contracts Registered',
    contracts_month_section_subtitle: 'List of engineering contracts archived in the system',
    col_contract_no: 'Contract No.',
    col_signing_date: 'Signing Date',
    total_contracts_value_label: 'Total Contracts Value',
    top_contract_label: 'Top Value Contract',

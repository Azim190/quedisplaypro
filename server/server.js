...
app.put('/api/quotations/:id', (req, res) => {
  try {
    ...
    stmt.run(
      data.titleAr !== undefined ? data.titleAr : null,
      data.titleEn !== undefined ? data.titleEn : null,
      data.branchId !== undefined ? data.branchId : null,
      data.clientNameAr !== undefined ? data.clientNameAr : null,
      data.clientNameEn !== undefined ? data.clientNameEn : null,
      data.projectNameAr !== undefined ? data.projectNameAr : null,
      data.projectNameEn !== undefined ? data.projectNameEn : null,
      data.projectTypeId !== undefined ? data.projectTypeId : null,
      data.quotationTypeId !== undefined ? data.quotationTypeId : null,
      amount,
      vatAmount,
      totalAmount,
      data.currency !== undefined ? data.currency : null,
      data.status !== undefined ? data.status : null,
      data.creationDate !== undefined ? data.creationDate : null,
...
app.put('/api/contracts/:id', (req, res) => {
  try {
    ...
    stmt.run(
      ...
      data.projectNameEn !== undefined ? data.projectNameEn : null,
      data.projectTypeId !== undefined ? data.projectTypeId : null,
      data.contractTypeId !== undefined ? data.contractTypeId : null,
      amount,
      vatAmount,
      totalAmount,
      data.currency !== undefined ? data.currency : null,
      data.status !== undefined ? data.status : null,
      data.signingDate !== undefined ? data.signingDate : null,
      data.validUntil !== undefined ? data.validUntil : null,
      data.fileLink !== undefined ? data.fileLink : null,
